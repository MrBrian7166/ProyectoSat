...
<?php $__env->startSection('title', 'Formulario Real SAT'); ?>
    ...
    <div class="card">
        <div class="card-header bg-success text-white">
            <h4 class="mb-0">
                ...
                <small class="float-end"><?php echo e($timestamp); ?></small>
            </h4>
        </div>
        <div class="card-body">
            <div class="alert alert-success">
                <h5><i class="fas fa-check"></i> ¡Formulario cargado exitosamente!</h5>
                <p><strong>URL:</strong> <code><?php echo e($resultado['url']); ?></code></p>
                <p><strong>Status:</strong> <span class="badge bg-success"><?php echo e($resultado['status_code']); ?></span></p>
                <p><strong>Tamaño:</strong> <?php echo e(number_format($resultado['content_length'])); ?> bytes</p>
                <p><strong>Tiempo respuesta:</strong> <?php echo e($resultado['response_time_ms']); ?> ms</p>
            </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <?php $__currentLoopData = $resultado['campos_encontrados']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nombre => $campo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-4 mb-3">
                            <div class="card h-100 <?php echo e($campo['encontrado'] ? 'border-success' : 'border-warning'); ?>">
                                <div class="card-body">
                                    <h6 class="card-title">
                                    ...
                                    <?php if($campo['encontrado']): ?>
                                        <?php if(!empty($campo['attributes'])): ?>
                                            <div class="small">
                                                <?php $__currentLoopData = $campo['attributes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($value): ?>
                                                    <div><strong><?php echo e($attr); ?>:</strong> <code><?php echo e($value); ?></code></div>
                                                    <?php endif; ?>
                                        ...
                                        <?php if($campo['html']): ?>
                                            <div class="mt-2">
                                                ...
                                                <pre class="bg-light p-2 small mb-0"><?php echo e($campo['html']); ?></pre>
                                            </div>
                                        <?php endif; ?>
                                    <?php else: ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="list-unstyled">
                                <li>
                                    <?php if($resultado['tiene_formulario']): ?>
                                        <i class="fas fa-check text-success"></i>
                                    <?php else: ?>
                                        <i class="fas fa-times text-danger"></i>
                                    <?php endif; ?>
                                    Tiene formulario: <?php echo e($resultado['tiene_formulario'] ? 'Sí' : 'No'); ?>

                                </li>
                                <li>
                                    <?php if($resultado['tiene_campos_archivo']): ?>
                                        <i class="fas fa-check text-success"></i>
                                    <?php else: ?>
                                        <i class="fas fa-times text-danger"></i>
                                    <?php endif; ?>
                                    Campos de archivo: <?php echo e($resultado['tiene_campos_archivo'] ? 'Sí' : 'No'); ?>

                                </li>
                                <li>
                                    <i class="fas fa-file-alt"></i>
                                    Content-Type: <?php echo e($resultado['content_type']); ?>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <pre style="max-height: 500px; overflow: auto; font-size: 11px; background: #f8f9fa; padding: 15px; border-radius: 5px;"><?php echo e(htmlspecialchars($resultado['html_preview'])); ?></pre>
                </div>
            </div>
            
            <div class="mt-4">
                <a href="<?php echo e(route('sat-test.index')); ?>" class="btn btn-primary">
                    <i class="fas fa-arrow-left"></i> Volver a Pruebas
                </a>
                <a href="<?php echo e(route('proceso.index')); ?>" class="btn btn-success">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ProyectoSAT\resources\views/sat-test/formulario-real.blade.php ENDPATH**/ ?>